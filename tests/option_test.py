...
class OptionTest(ProbackupTest, unittest.TestCase):
    ...
    def test_without_backup_path_3(self):
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because '-B' parameter is not specified.\n Output: {0} \n CMD: {1}".format(
    ...
    def test_options_4(self):
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because 'instance' parameter is not specified.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because backup-mode parameter is invalid.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because delete options are omitted.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because backup ID is omitted.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
    ...
    def test_options_5(self):
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because of garbage in pg_probackup.conf.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because of invalid backup-mode in pg_probackup.conf.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because option system-identifier cannot be specified in command line.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                "Expecting Error because option -C should be boolean.\n Output: {0} \n CMD: {1}".format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
        ...
        try:
            ...
            self.assertEqual(
                1,
                0,
                'Expecting Error because of invalid option "TIMELINEID".\n Output: {0} \n CMD: {1}'.format(
                    repr(self.output), self.cmd
                ),
            )
        except ProbackupException as e:
    ...
    def test_help_6(self):
        ...
        if ProbackupTest.enable_nls:
            if check_locale("ru_RU.utf-8"):
                ...
                self.skipTest("Locale ru_RU.utf-8 doesn't work. You need install ru_RU.utf-8 locale for this test")
        else:
            self.skipTest("You need configure PostgreSQL with --enabled-nls option for this test")
    ...
    def test_options_no_scale_units(self):
        ...
        output = self.run_pb(
            ["show-config", "--backup-path", backup_dir, "--instance=node", "--no-scale-units", "--format=json"]
        )
        self.assertIn(container=output, member='"archive-timeout": 300,')
